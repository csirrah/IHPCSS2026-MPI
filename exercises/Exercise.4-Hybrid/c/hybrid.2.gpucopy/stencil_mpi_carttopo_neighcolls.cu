...
int main(int argc, char **argv) {
  ...
  /* ===================================================================== */
  // Step 1: allocate the rbuf on the device (see sbuf above for syntax)
  // TODO declare the pointer
  // TODO allocate device memory
  // TODO set the device memory to zero
  /* ===================================================================== */
  ...
  for(int iter=0; iter<niters; ++iter) {
    ...
    //cudaMemcpy2D(sbuf, b_pitch, &d_aold[ind(1,1)], d_pitch, width, by, cudaMemcpyDeviceToDevice); // pack west
    //cudaMemcpy2D(&sbuf[by], b_pitch, &d_aold[ind(bx,1)], d_pitch, width, by, cudaMemcpyDeviceToDevice); // pack east
    //cudaMemcpy(&sbuf[2*by], &d_aold[ind(1,1)], bx*sizeof(double), cudaMemcpyDeviceToDevice);  // pack north
    //cudaMemcpy(&sbuf[2*by+bx], &d_aold[ind(1,by)], bx*sizeof(double), cudaMemcpyDeviceToDevice);  // pack south
    /* ===================================================================== */
    // Step 2: change the above cudaMemcpy to cudaMemcpyDeviceToDevice
    // TODO pack west
    // TODO pack east
    // TODO pack north
    // TODO pack south
    ...
    MPI_Status status;
    /* ===================================================================== */
    // Step 3: does anything need to change here?
    /* ===================================================================== */
    ...
    //cudaMemcpy2D(&d_aold[ind(0,1)], d_pitch, rbuf, b_pitch, width, by, cudaMemcpyDeviceToDevice); // unpack west
    //cudaMemcpy2D(&d_aold[ind(bx+1,1)], d_pitch, &rbuf[by], b_pitch, width, by, cudaMemcpyDeviceToDevice); // unpack east
    //cudaMemcpy(&d_aold[ind(1,0)], &rbuf[2*by], bx*sizeof(double), cudaMemcpyDeviceToDevice); // unpack north
    //cudaMemcpy(&d_aold[ind(1,by+1)], &rbuf[2*by+bx], bx*sizeof(double), cudaMemcpyDeviceToDevice); // unpack south
    /* ===================================================================== */
    // Step 4: change the above cudaMemcpy to cudaMemcpyDeviceToDevice
    // TODO pack west
    // TODO pack east
    // TODO pack north
    // TODO pack south
  ...
  /* ===================================================================== */
  // Step 5: these are now device allocations and should be cudaFree
  free(sbuf); // TODO call cudaFree instead of free
  free(rbuf); // TODO call cudaFree instead of free
  /* ===================================================================== */
